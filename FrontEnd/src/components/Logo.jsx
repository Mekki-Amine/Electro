    ...
    return (
      ...
      >
        <g stroke="#000" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
          ...
          <rect x="50" y="60" width="90" height="10" rx="3" fill="#808080" />
          <circle cx="10" cy="76" r="14" fill="#808080" />
          <circle cx="10" cy="76" r="7" fill="#fff" />
          <circle cx="120" cy="76" r="14" fill="#808080" />
          <circle cx="140" cy="76" r="7" fill="#fff" />
        </g>
      </svg>
    );
  }
